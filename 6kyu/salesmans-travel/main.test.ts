import { travel, parseAddressLine } from './main';
...
describe("unit test for parseAddressLine", (() => {
    test("valid address", () => {
        const validAddress = "54 Holy Grail Street Niagara Town ZP 32908"
        const result = parseAddressLine(validAddress);
        expect(result).toStrictEqual({
            houseNumber: "54",
            streetAndTown: "Holy Grail Street Niagara Town",
            zipCode: "ZP 32908"
        });
    })
    ...
    test("valid address", () => {
        ...
        const result = parseAddressLine(invalidAddress);
